...
> **Self-join rules-hardening** — the self-join rules envelope still permits a `['player']` value → a determined user could self-join-as-player at the rules level. Isolation-adjacent → own brief with in-brief CONFIRM before `firestore:rules` deploy.
