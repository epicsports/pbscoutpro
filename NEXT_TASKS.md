...
**Last synced:** 2026-05-27 · main HEAD `e4c7c585` (A2 v2 ShotDrawer drag-move-shot + tap-marker menu SHIPPED + deployed — Active queue #1 CLOSED; dualwrite-orphans + B15 scripts + gap β sibling + KIOSK + B14 + B13 + B19 + B16-B18 + § 88 + gap α/β + B7 SHIPPED earlier today — 13 ships + adminUid script. B15 cleanup pending Jacek audit run; PART 3 linkedUid backstop = `[ESCALATE]`, not touched.)
