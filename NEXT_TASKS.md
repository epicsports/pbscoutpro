...
**Last updated:** 2026-05-01 by CC implementation (Training scouting flow fix shipped — 3 commits on fix/training-scouting-flow merged via 34b8960, deployed. Bug A awaySquad routing, Bug C 3-stage QuickLog with mandatory zones, Bug B canvas prefill via ?point=<pid>. Set→Array selection state. Pre-existing goScout ReferenceError fixed in passing. Brief archived. Pre-niedzielny-sparing 2026-05-03.)
