...
const SEED = [
  ...
  { id: 's1', type: 'shot', kind: 'directional', playerId: 'p1', zone: 'dorito', color: '#fb923c', phase: 'breakout' },
  { id: 's2', type: 'shot', kind: 'directional', playerId: 'p2', zone: 'snake', color: '#22d3ee', phase: 'breakout' },
