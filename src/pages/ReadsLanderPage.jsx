  ...
  return (
    <div data-testid="reads-lander"
      ...
      <div style={{ position: 'relative', width: '100%', maxWidth: 440, flex: 1, minHeight: 0, padding: `0 ${SPACE.md}px`, display: 'flex', alignItems: 'center', justifyContent: 'center', boxSizing: 'border-box' }}>
        <div style={{ position: 'relative', width: '100%', maxWidth: '100%', maxHeight: '100%', aspectRatio: '160 / 224', borderRadius: RADIUS.lg, overflow: 'hidden', border: `1px solid #241a08`, boxShadow: 'inset 0 0 40px rgba(0,0,0,.85)' }}>
