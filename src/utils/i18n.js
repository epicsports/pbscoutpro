...
const T = {
  ...
  pl: {
    ...
    callout_obstacle_label:'Na przeszkodzie',
    callout_inferred_note: 'Bunkier orientacyjny — wyliczony z pozycji, nie zadeklarowany.',
  ...
  en: {
    ...
    callout_break_label:   'Break',
    callout_obstacle_label:'At obstacle',
    callout_inferred_note: 'Bunker is inferred from position — derived, not declared.',
