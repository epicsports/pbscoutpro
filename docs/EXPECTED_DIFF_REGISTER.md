...
|---|---|---|---|---|---|
| 2026-06-12 | (H2 batch 2, pending) | MatchPage gradient, PlayerStatsPage | `#080c14` → `COLORS.bg` `#0a0e17` (2 call sites) — perceptually ~zero, pixels change | `#080c14` is the documented phantom colour (REVIEW_CHECKLIST §2: "the old #080c14 was a phantom, never a token"); occurrences are phantom leakage, not design | planned |
