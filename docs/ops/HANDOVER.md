...
**Last updated:** 2026-05-12 by CC (deaths heatmap landscape width shipped — merge `3737705` + deploy + DEPLOY_LOG)
**Live app:** https://epicsports.github.io/pbscoutpro
**Repo:** https://github.com/epicsports/pbscoutpro
**Main HEAD at last update:** post-`3737705` deaths heatmap landscape-width merge (see `DEPLOY_LOG.md` 2026-05-12)
