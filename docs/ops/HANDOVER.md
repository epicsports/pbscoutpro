...
## 🚢 Recently shipped (2026-04-13 → 2026-04-24)

Four sprint days: **2026-04-21** (concurrent scouting architectural redesign pre-Saturday), **2026-04-22** (backlog batch — 7 briefs A–G end-to-end), **2026-04-23** (two Tier-2 multi-checkpoint products), **2026-04-24** (§ 50 Settings reorg + four polish/hotfix briefs into NXL Czechy Saturday). Chronological, newest first:
...
`docs/DESIGN_DECISIONS.md` holds 52 numbered sections + sub-sections 5.7 / 33.1 / 33.2 / 35.5 (rewritten) / 35.7. Most recent (newest first):
