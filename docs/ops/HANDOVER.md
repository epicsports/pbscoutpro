...
**Last updated:** 2026-05-12 by CC (deaths heatmap cluster + z-order shipped — merge `555a634` + deploy + DEPLOY_LOG)
**Live app:** https://epicsports.github.io/pbscoutpro
**Repo:** https://github.com/epicsports/pbscoutpro
**Main HEAD at last update:** post-`555a634` deaths heatmap cluster+z-order merge (see `DEPLOY_LOG.md` 2026-05-12)
