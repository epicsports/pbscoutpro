...
**Last updated:** 2026-05-15 by CC (Coach tab division-filter repair deployed at NXL Czechy day 1)
**Live app:** https://epicsports.github.io/pbscoutpro
**Repo:** https://github.com/epicsports/pbscoutpro
**Main HEAD at last update:** `e0e3e6b` (merge `fix/schedule-import-scouted-division`) — see `DEPLOY_LOG.md` 2026-05-15
