...
**Last updated:** 2026-05-12 by CC (match post-close edit + scout preservation shipped — merge `ae3627f` + deploy + DEPLOY_LOG)
**Live app:** https://epicsports.github.io/pbscoutpro
**Repo:** https://github.com/epicsports/pbscoutpro
**Main HEAD at last update:** post-`ae3627f` match post-close edit merge (see `DEPLOY_LOG.md` 2026-05-12)
